...
const projectData = [
  ...
  {
    id: 3,
    title: "Uni-T Fashion E-commerce Website",
    category: "Web Development",
    thumbnailImg: "",
    description: "Uni-T is a modern fashion e-commerce website showcasing men’s and women’s and more clothing collections with a clean, responsive, and user-friendly design.",
    tags: ["React", "Tailwind CSS", "Node JS", "MongoDB", "Rest API"],
  },
  {
    id: 4,
    title: "Uni-T Fashion E-commerce Website UI Design",
    category: "UX/UI",
    thumbnailImg: "",
