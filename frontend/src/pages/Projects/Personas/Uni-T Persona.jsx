...
import P1 from "../../../assets/persona/Uni-T/Persona 1.png";
import P2 from "../../../assets/persona/Uni-T/Persona 2.png";
import P3 from "../../../assets/persona/Uni-T/Persona 3.png";

const originalImages = [P1, P2, P3];
...
export default function PersonaSlider() {
  ...
  return (
    <div className="relative overflow-hidden rounded-4xl max-w-5xl mx-auto">
      <div
        className="flex"
        style={{
